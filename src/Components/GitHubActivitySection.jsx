...
import {
  buildGithubHeatmap,
  generateFallbackGithubContributions,
} from "./githubUtils";

// Replace with your own icons if you already have them
    ...
    async function loadGithubData() {
      try {
        const [y2025, y2026] = await Promise.all([
          fetch(`${githubContributionsApi}?y=2025`).then((r) =>
            r.json()
          ),
          fetch(`${githubContributionsApi}?y=2026`).then((r) =>
            r.json()
          ),
        ]);
      ...
      >
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div>
            ...
            "
            >
              Live contribution graph synced with GitHub.
            </p>
